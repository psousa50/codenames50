import { RevealWordInput, CreateGameInput, JoinGameInput, ChangeTurnInput } from "../models"
...
export const changeTurnMessage = (data: ChangeTurnInput) => createSocketMessage("changeTurn", data)
